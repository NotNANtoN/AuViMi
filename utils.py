...
def get_args():
    ...
    parser.add_argument(
        "--use_gabor", type=int, default=0, help="Use Gabor wavelet activation (WIRE) instead of Sine (SIREN)."
    )
    ...
    parser.add_argument(
        "--aug_both", type=int, default=0, help="Apply the same augmentations to both source and target image."
    )
